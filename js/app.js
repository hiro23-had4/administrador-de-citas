...
class Notificacion {
    ...
    mostrar() {
        ...
        alertaPrevia?.remove(); // una mejor forma
        // if(alertaPrevia) {
        //     alertaPrevia.remove()
        // }

        // Si es de tipo error, agregar una clase ternario
...
class AdminCitas {
    ...
    mostrar() {
        ...
        this.citas.forEach(cita => {
            ...
            const clone = structuredClone(cita); // clona la cita
...
function submitCita(e) {
    ...
    // simplificar la condicion del formulario
    ...
    if (editando) {
        ...
        citas.agregar({ ...citaObj }); // le pasamos una sola copia
        new Notificacion({
    ...
    formulario.reset();
    reiniciarObjtoCita(); // se llama al objeto
    formularioInput.value = 'Registrar Paciente'
    editando = false
}

function reiniciarObjtoCita() {
...
// esta es una forma de hacer la validacion del formulario
